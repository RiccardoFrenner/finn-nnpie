...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figs/retardation_uniqueness.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{figs/finn_mcmc_samples.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{figs/finn_synthetic_SPAN_factors_PIs.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{figs/finn_synthetic_langmuir_c_noise.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{figs/finn_My MCMCvsFull SPAN_PIs.pdf}
