...
% TODO: $R(c)$ values --> $R(c)$-values ?
% TODO: Lücke zwischen Fig. und nummer überprüfen. Falls zu groß, ~\Cref verwenden.
...
% TODO: Check ob der name wirklich jetzt da steht.
...
% TODO: Better footnote (finish it at least...)
% TODO: Check if footnote is correctly formatted.
...
% \paragraph{Hy-NNPIE}
% TODO: Check if this looks better than paragraph
...
% TODO: What about "physics-informed" here?
\begin{itemize}
...
% TODO: white space between figure and number
...
% TODO: github umbennen zu finn-nnpie
...
% TODO: check if this looks better as paragraph
...
\Cref{fig:sensitivity} shows the relative importance for values of $c$ over which the average was taken.
...
Given that HyDa-NNPIE produces similar PIs for $c$ but incorporates larger uncertainty in $R(c)$, it provides a more robust uncertainty estimate. A more quantitative exploration of these findings is presented in the following sections. % TODO: check if this is really true
...
% TODO: I get an ESS (effective sampling size) of 5 for the 10,000 weight samples of MCMC. This is so bad, it cannot even be true, can it? (For ret samples it is at least a bit better: ESS=20)
