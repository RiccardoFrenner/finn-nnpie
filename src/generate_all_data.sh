for analytical_ret in "freundlich"; do
    ...
    python src/train_finn.py ${default_c_train} "data_out/${analytical_ret}/default_finn" -s 51 --max_epochs ${max_epochs} --seed 564345
    ...
    # python src/train_finn.py ${default_c_train} "data_out/finn_with_dropout/p=10" -s 51 --max_epochs ${max_epochs} --seed 2134834 --dropout 10
    # python src/train_finn.py ${default_c_train} "data_out/finn_with_dropout/p=50" -s 51 --max_epochs ${max_epochs} --seed 3485637 --dropout 50
    # python src/train_finn.py ${default_c_train} "data_out/finn_with_dropout/p=90" -s 51 --max_epochs ${max_epochs} --seed 9837432 --dropout 90

    # echo "Train FINN with github data and self-generated data to compare both"
    # parallel --bar python src/train_finn.py "data/synthetic_data/FINN_forward_solver/retardation_{}/c_train.npy" "data_out/FINN_forward_tests/finn_{}_selfgen_c" -s 51 --max_epochs ${max_epochs} --seed 123456 ::: langmuir freundlich linear
    # parallel --bar python src/train_finn.py "data/synthetic_data/retardation_{}/c_train.npy" "data_out/FINN_forward_tests/finn_{}_github_c" -s 51 --max_epochs ${max_epochs} --seed 123456 ::: langmuir freundlich linear
    ...
    # parallel --bar -j 8 python src/train_finn.py "data/synthetic_data/retardation_langmuir/c_train.npy" "data_out/FINN_forward_tests/finn_langmuir_github_c_{}" -s 51 --max_epochs ${max_epochs} --seed {} ::: 3546 4385763 238479 98789354 626734 37264333 598567 554242
    ...
    # parallel --bar -j 8 python src/train_finn.py "data/synthetic_data/FINN_forward_solver/retardation_freundlich/c_train.npy" "data_out/FINN_forward_tests/finn_freundlich_selfgen_c_{}" -s 51 --max_epochs ${max_epochs} --seed {} ::: 3546 4385763 238479 98789354 626734 37264333 598567 554242
