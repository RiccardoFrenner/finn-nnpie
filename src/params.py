...
breakthrough_mult = (
    1  # multiplier for the breakthrough curve error in the loss function calculation
)
profile_mult = (
    1  # multiplier for the concentration profile error in the loss function calculation
)
phys_mult = (
